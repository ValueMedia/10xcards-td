...
- [x] 2.3 Upload a valid `.csv` file: preview step shows correct cards — 1e85ec5
- [x] 2.4 Upload a file with some invalid lines: skip count matches expected — 1e85ec5
- [x] 2.5 Delete a card from preview: entry disappears from the list — 1e85ec5
- [x] 2.6 Import: cards appear in the set's flashcard list without page reload — 1e85ec5
- [x] 2.7 Upload file > 1 MB: error message shown, step stays at upload — 1e85ec5
- [x] 2.8 Upload file with 0 valid lines: error message shown, step stays at upload — 1e85ec5

### Phase 3: SetDetailPage integration

#### Automated

- [x] 3.1 `npm run lint` passes — 1e85ec5
- [x] 3.2 `npm run build` passes — 1e85ec5

#### Manual

- [x] 3.3 "Import CSV" button is visible in the set detail page action row — 1e85ec5
- [x] 3.4 Full flow works end-to-end: open → select → preview → import → list updates + toast — 1e85ec5
- [x] 3.5 Toast shows correct imported count and skipped line count — 1e85ec5
